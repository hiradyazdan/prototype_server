...
{
    internal class PlayerControllerSpec : NetworkSpecs
    {
        ...
        private void WhenPlayerMoves()
        {
            beforeEach = () =>
            {
                ...
                var readerMock = Helpers.GetReaderMock(_playerMock, PacketTypes.Position, rawDataSize);
            ...
            it["should sync game state with all connected clients"] = () =>
            {
                _subject.SyncWithConnectedPeers();
                
                var dataWriter = new NetDataWriter();
                
                dataWriter.Put((int)PacketTypes.Positions);
                ...
                NetworkService.DataWriter.Data.Should().BeEquivalentTo(dataWriter.Data);
            };
        }
    }
...
//    }
//    
//    public class WhenPlayerMoves : NetworkSpecs
//    {
//        private PlayerController _subject;
//        private RedisCache _redisCache;
//        private Player _playerMock;
